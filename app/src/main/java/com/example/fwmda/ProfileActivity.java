...
public class ProfileActivity extends AppCompatActivity {
    ...
    private TextView type, name, email, idNumber, phoneNumber, donorGroup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("My Profile"); //setting action bar title name
        ...
        //donorGroup = findViewById(R.id.donorGroup);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    //donorGroup.setText(snapshot.child("donorgroup").getValue().toString());
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                finish();// move user from ProfileActivity to MainActivity
                return true;
            default:
