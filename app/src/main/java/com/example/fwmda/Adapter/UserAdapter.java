...
import com.example.fwmda.Email.JavaMailApi;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
       ...
       holder.donorGroup.setText(user.getDonorgroup());
                           ...
                           public void onClick(DialogInterface dialogInterface, int i) {
                               ...
                               reference.addValueEventListener(new ValueEventListener() {
                                   ...
                                   public void onDataChange(@NonNull DataSnapshot snapshot) {
                                       ...
                                       //String donor = snapshot.child("donorgroup").getValue().toString();

                                       String mEmail = user.getEmail();
                                       String mSubject = "FOOD DONATION";
                                       String mMessage = "Hello "+ nameOfTheReceiver+", "+nameOfSender+
                                               "Kindly accepts your donation. Here are the details:\n"
                                               +"Name: "+nameOfSender+ "\n"+
                                               "Phone Number: "+phone+ "\n"+
                                               "Email: " +email+"\n"+
                                               "Thank you for your donation and Kindness. \n"
                                               +"FOOD DONATION APP - DONATE FOOD, REDUCE WASTAGE AND SAVE LIVES!";
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView type, userName, userEmail, phoneNumber, donorGroup;
    ...
    private void addNotification(String receiverId, String senderId){
        ...
        // to save the data use hashMap - using Key Value Pairs
