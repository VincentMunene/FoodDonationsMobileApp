...
public class DonorRegistrationActivity extends AppCompatActivity {
    ...
    private Spinner donorGroupsSpinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donorGroupsSpinner = findViewById(R.id.donorGroupsSpinner);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               final String donorGroup = donorGroupsSpinner.getSelectedItem().toString();
               ...
               if(TextUtils.isEmpty(email)){
                ...
                if(donorGroup.equals("donorGroups")){
                    Toast.makeText(DonorRegistrationActivity.this, "Select Donor group",Toast.LENGTH_SHORT).show();
                    return;
                }
                    ...
                    mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()){
                                ...
                                userInfo.put("donorgroup", donorGroup);
                                userInfo.put("type", "donor");
                                userInfo.put("search", "donor" +donorGroup);
